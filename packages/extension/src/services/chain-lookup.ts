...
const DEFAULT_RPC_PROVIDER = 'https://eth-mainnet.g.alchemy.com/v2/demo';

class ChainLookup 
{
    constructor()
    {
        this.web3 = new Web3(new Web3.providers.HttpProvider(DEFAULT_RPC_PROVIDER)); 
    ...
    setupFormSubmitHandler()
    {
        if(document.querySelector(FORM_CHAIN_LOOKUP_SELECTOR)) {
            ...
            document.querySelector(FORM_CHAIN_LOOKUP_SELECTOR).addEventListener('submit', async (event) => {
                ...
                this.strBlockExplorer = "https://etherscan.io/address";
